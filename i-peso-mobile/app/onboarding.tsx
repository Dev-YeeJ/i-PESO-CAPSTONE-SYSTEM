...
const styles = StyleSheet.create({
  ...
  container: { paddingHorizontal: spacing.xl, paddingTop: 56, paddingBottom: spacing.xxxl },
  kicker: { color: colors.info, fontSize: typography.small, fontFamily: typography.family.bold, textTransform: 'uppercase', letterSpacing: 1.2 },
  title: { marginTop: spacing.sm, color: colors.primary, fontSize: typography.hero, fontFamily: typography.family.display },
  subtitle: { marginTop: spacing.xs, color: colors.secondaryText, fontSize: typography.body, lineHeight: 20 },
  ...
  stepSegmentDone: { backgroundColor: colors.info },
  ...
  secondaryButtonText: { color: colors.muted, fontSize: typography.body, fontFamily: typography.family.bold },
  primaryButton: { flex: 1.4, backgroundColor: colors.info, borderRadius: radii.lg, paddingVertical: spacing.lg, alignItems: 'center' },
