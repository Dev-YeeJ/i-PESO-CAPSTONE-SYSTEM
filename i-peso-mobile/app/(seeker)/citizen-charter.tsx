...
const styles = StyleSheet.create({
  ...
  serviceTitle: { flex: 1, color: colors.textPrimary, fontSize: typography.title, lineHeight: 22, fontFamily: typography.family.bold },
  ...
  sectionLabel: { color: colors.textPrimary, fontSize: typography.small, fontFamily: typography.family.bold, marginTop: spacing.md, marginBottom: spacing.xs },
