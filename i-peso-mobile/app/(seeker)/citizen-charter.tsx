...
const styles = StyleSheet.create({
  ...
  serviceTitle: { flex: 1, color: colors.primary, fontSize: typography.title, lineHeight: 22, fontWeight: typography.bold },
  ...
  sectionLabel: { color: colors.primary, fontSize: typography.small, fontWeight: typography.bold, marginTop: spacing.md, marginBottom: spacing.xs },
