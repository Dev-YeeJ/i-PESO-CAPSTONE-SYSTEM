...
const styles = StyleSheet.create({
  ...
  search: { backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.subtle, borderRadius: radii.md, paddingHorizontal: spacing.md, paddingVertical: spacing.md, color: colors.primary, fontSize: typography.body },
  searchRow: { flexDirection: 'row', gap: spacing.sm, marginBottom: spacing.sm },
  searchInput: { flex: 1, marginBottom: 0 },
  aiSearchBtn: { backgroundColor: colors.info, borderRadius: radii.md, paddingHorizontal: spacing.lg, alignItems: 'center', justifyContent: 'center' },
  aiSearchBtnText: { color: colors.white, fontSize: typography.small, fontWeight: typography.bold },
  ...
  filterLabel: { color: colors.muted, fontSize: typography.small, fontWeight: typography.bold, marginTop: spacing.sm, marginBottom: spacing.xs },
  ...
  missingText: { marginTop: spacing.sm, color: colors.danger, fontSize: typography.small, fontWeight: typography.medium },
})
