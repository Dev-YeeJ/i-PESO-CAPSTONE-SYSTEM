...
const styles = StyleSheet.create({
  ...
  title: { flex: 1, color: colors.primary, fontSize: typography.heading, lineHeight: 30, fontWeight: typography.bold },
  ...
  listRowText: { color: colors.primary, fontSize: typography.body, fontWeight: typography.semibold, flex: 1, marginRight: spacing.sm },
