...
export default function ApplicationDetailScreen() {
  ...
  const withdrawMutation = useMutation({
    ...
    onError: (caught: unknown) => {
      ...
      setWithdrawError(body?.message || 'Unable to withdraw this application.')
    },
  })
...
const styles = StyleSheet.create({
  ...
  notFoundTitle: { color: colors.primary, fontSize: typography.title, fontWeight: typography.bold },
  content: { padding: spacing.xl, paddingBottom: spacing.xxxl },
  alertBox: { marginBottom: spacing.lg },
  jobTitle: { color: colors.primary, fontSize: typography.heading, lineHeight: 30, fontWeight: typography.bold },
  ...
  timelineTitle: { color: colors.primary, fontSize: typography.body, fontWeight: typography.semibold },
