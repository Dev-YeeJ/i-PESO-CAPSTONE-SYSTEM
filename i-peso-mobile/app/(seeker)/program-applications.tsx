...
const styles = StyleSheet.create({
  ...
  appTitle: { flex: 1, color: colors.primary, fontSize: typography.title, lineHeight: 22, fontWeight: typography.bold },
  appMeta: { color: colors.secondaryText, fontSize: typography.small, marginTop: spacing.xs },
  remarksBox: { backgroundColor: colors.background, borderRadius: radii.md, padding: spacing.md, marginTop: spacing.md },
  remarksLabel: { color: colors.primary, fontSize: typography.small, fontWeight: typography.bold, marginBottom: spacing.xs },
  remarksText: { color: colors.secondaryText, fontSize: typography.small, lineHeight: 18 },
  certificateRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.xs, marginTop: spacing.md },
  certificateText: { color: colors.success, fontSize: typography.small, fontWeight: typography.semibold },
  documentsSection: { marginTop: spacing.md, borderTopWidth: 1, borderTopColor: colors.border, paddingTop: spacing.md },
  documentsTitle: { color: colors.primary, fontSize: typography.small, fontWeight: typography.bold, marginBottom: spacing.sm },
  ...
  documentName: { color: colors.primary, fontSize: typography.small, fontWeight: typography.semibold },
  documentType: { color: colors.secondaryText, fontSize: typography.label, marginTop: 2 },
  toggleRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.xs, marginTop: spacing.md },
  toggleText: { color: colors.info, fontSize: typography.small, fontWeight: typography.bold },
  uploadForm: { marginTop: spacing.md, gap: spacing.sm },
  typeRow: { flexDirection: 'row', gap: spacing.sm },
  typeChip: { borderWidth: 1, borderColor: colors.subtle, backgroundColor: colors.surface, borderRadius: radii.pill, paddingVertical: spacing.sm, paddingHorizontal: spacing.md },
  typeChipActive: { backgroundColor: colors.info, borderColor: colors.info },
  typeChipText: { color: colors.muted, fontSize: typography.small, fontWeight: typography.bold },
  typeChipTextActive: { color: colors.white },
  input: { backgroundColor: colors.background, borderWidth: 1, borderColor: colors.subtle, borderRadius: radii.md, paddingHorizontal: spacing.md, paddingVertical: spacing.md, color: colors.primary, fontSize: typography.body },
