...
const styles = StyleSheet.create({
  ...
  strengthCard: { flexDirection: 'row', alignItems: 'center', gap: spacing.lg, backgroundColor: colors.surface, marginBottom: spacing.lg, padding: spacing.md },
  strengthText: { flex: 1 },
  ...
  strengthCtaText: { fontSize: typography.small, fontFamily: typography.family.bold, color: colors.accent },
