...
const styles = StyleSheet.create({
  ...
  bellBtn: { width: 48, height: 48, borderRadius: 24, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, alignItems: 'center', justifyContent: 'center' },
  bellBadge: { position: 'absolute', top: -6, right: -6, minWidth: 18, height: 18, borderRadius: 9, backgroundColor: colors.error, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 4 },
  ...
  greetingText: { fontSize: typography.small, color: colors.textSecondary, fontFamily: typography.family.medium },
  nameText: { fontSize: typography.heading, color: colors.textPrimary, fontFamily: typography.family.medium },
  ...
  strengthCard: { flexDirection: 'row', alignItems: 'center', gap: spacing.lg, backgroundColor: colors.surface, marginBottom: spacing.lg, padding: spacing.md, borderRadius: radii.xl, borderWidth: 1, borderColor: colors.border },
  strengthText: { flex: 1 },
  ...
  strengthCtaText: { fontSize: typography.small, fontFamily: typography.family.bold, color: colors.secondary },
  readinessCard: { backgroundColor: colors.surface, borderRadius: radii.xl, borderWidth: 1, borderColor: colors.border, padding: spacing.md, marginBottom: spacing.lg },
  readinessHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: spacing.sm },
  readinessDesc: { color: colors.textSecondary, fontSize: typography.body, lineHeight: 20 },
  statsRow: { flexDirection: 'row', gap: spacing.sm },
  actionsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm },
  actionCard: { width: '48%', backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, borderRadius: radii.md, padding: spacing.md, alignItems: 'center', justifyContent: 'center', gap: spacing.sm },
  ...
  actionLabel: { color: colors.textPrimary, fontSize: typography.small, fontFamily: typography.family.bold, textAlign: 'center' },
  viewAllText: { color: colors.secondary, fontSize: typography.small, fontFamily: typography.family.bold },
  feedModeControl: { marginTop: spacing.xl },
  jobCard: { marginBottom: spacing.md, paddingVertical: spacing.sm },
  jobCardHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', gap: spacing.md },
  jobTitleWrap: { flex: 1 },
  jobTitle: { color: colors.textPrimary, fontSize: typography.title, fontFamily: typography.family.bold, lineHeight: 22 },
  jobCompany: { color: colors.textSecondary, fontSize: typography.small, fontFamily: typography.family.medium, marginTop: spacing.xs },
  jobMetaContainer: { flexDirection: 'row', alignItems: 'center', gap: spacing.xs, marginTop: spacing.sm, marginBottom: spacing.sm },
  jobMeta: { color: colors.textSecondary, fontSize: typography.small, lineHeight: 18 },
  employmentBadge: { alignSelf: 'flex-start', marginBottom: spacing.md },
  cardActionButton: { borderColor: colors.border, backgroundColor: colors.accentSoft },
