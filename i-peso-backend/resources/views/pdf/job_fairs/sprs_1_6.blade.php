...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr><td>Audit</td><td>Admin Proxy Encoded Reports</td><td>{{ $summary['admin_proxy_reports'] ?? 0 }}</td></tr>
        </tbody>
    </table>

    <p class="muted">Generated by i-PESO from deduplicated employer self-service and Admin Proxy Encoded post-event reports on {{ now()->format('F d, Y h:i A') }}.</p>
</body>
</html>
