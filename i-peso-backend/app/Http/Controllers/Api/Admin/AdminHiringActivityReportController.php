...
/**
 * A read-only cross-reference over every application any employer's
 * vacancies have received — online and job-fair sourced alike. This is NOT
 * the official monthly Placement Report (that's the employer-submitted
 ...
 */
class AdminHiringActivityReportController extends Controller
{
