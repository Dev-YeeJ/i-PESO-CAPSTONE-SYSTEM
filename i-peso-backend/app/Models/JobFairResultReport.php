...
{
    protected $fillable = [
        'job_fair_id', 'job_fair_employer_id', 'employer_id', 'company_name', 'office_location', 'clearance_no',
        'normalized_company_name', 'dedupe_key', 'employer_type', 'source', 'contact_person', 'contact_number',
    ...
    protected $casts = [
        ...
        'total_qualified' => 'integer', 'total_hots' => 'integer', 'total_near_hired' => 'integer', 'total_rejected' => 'integer',
    ...
    public function encodedByAdmin(): BelongsTo { return $this->belongsTo(Administrator::class, 'encoded_by_admin_id', 'admin_id'); }
}
