...
export const adminService = {
  ...
  reviewJobFairConfirmationSlip: async (id, payload) => (await api.patch(`/admin/job-fair-confirmation-slips/${id}/review`, payload)).data,
  reviewJobFairResult: async (id, payload) => (await api.patch(`/admin/job-fair-results/${id}/review`, payload)).data,
